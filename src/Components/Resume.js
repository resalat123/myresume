    ...
    render() {
            ...
            <div  className="twelve columns">
             ...
             var work = this.props.data.work.map(function(job){
               ...
               <div className="twelve columns">
                  ...
                  <h3>{job.company}</h3>
                  <p className="info">{job.title} <span>&bull;</span> <em className="date">{job.year}</em></p>
      ...
      <div className="row skill">
         ...
         <div className="nine columns main-col">
            ...
            <p>I have gained all these skills in my academic life. Trying to achieve more.</p>
